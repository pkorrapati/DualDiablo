...
#include "dd_motion_msgs/msg/detail/pose_ctrl__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dd_motion_msgs
cdr_serialize(
  const dd_motion_msgs::msg::PoseCtrl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dd_motion_msgs::msg::PoseCtrl & ros_message)
{
  // Member: fl_x
  cdr >> ros_message.fl_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dd_motion_msgs::msg::PoseCtrl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dd_motion_msgs::msg::PoseCtrl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dd_motion_msgs::msg::PoseCtrl *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dd_motion_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<dd_motion_msgs::msg::PoseCtrl>()
{
  return &dd_motion_msgs::msg::typesupport_fastrtps_cpp::_PoseCtrl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dd_motion_msgs, msg, PoseCtrl)() {
  return &dd_motion_msgs::msg::typesupport_fastrtps_cpp::_PoseCtrl__handle;
}
