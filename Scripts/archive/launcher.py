...
class DiabloSceneCfg(InteractiveSceneCfg):
    ...
    robot = ArticulationCfg(prim_path="/World/DualDiablo", 
                            spawn=sim_utils.UsdFileCfg(usd_path="C:/Projects/DualDiablo/Models/IsaacSim/DualDiablo.usd",
                            ...
                            actuators={
                                ...
                                # joint_names_expr=["Joint_L_Wheel_D_01"], 
...
# def generateSceneElements():# -> tuple[dict, list[list[float]]]:
#     # Create World
#     # prim_utils.create_prim("/World", "Xform")

#     # Ground Plane
#     groundPlaneMaterial = sim_utils.RigidBodyMaterialCfg(static_friction=1, dynamic_friction=1, restitution=0)
#     groundPlaneMaterial.func("/Materials/GroundPlaneMaterial", groundPlaneMaterial)

#     # TODO: Add usd path to args for user to input on the fly
#     groundPlane = sim_utils.GroundPlaneCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Environments/Grid/default_environment.usd", physics_material=groundPlaneMaterial) # , usd_path=""
#     groundPlane.func("/GroundPlane", groundPlane)
    
#     # Spawn a Distant Light
#     # DistantLightCfg
#     distantLight = sim_utils.DomeLightCfg(
#         intensity=3000.0,
#         color=(1.0, 1.0, 1.0)
#     )
#     distantLight.func("/Environment/DefaultLight", distantLight, translation=(1, 0, 10))

#     robotCFG = sim_utils.UsdFileCfg(usd_path="C:/Projects/DualDiablo/Models/IsaacSim/DualDiablo.usd")
#     robotCFG.func("/DualDiablo", robotCFG)
    # robot
