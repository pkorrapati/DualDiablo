...
#include "custom_msgs/msg/pose_ctrl.hpp"
#include "visibility_control.h"
#include "class_loader/multi_library_class_loader.hpp"
#include "ROS2PubSubTemplates.hpp"
class CUSTOM_MSGS_EXPORT ros2_custom_msgs_msg_PoseCtrl_common : public MATLABROS2MsgInterface<custom_msgs::msg::PoseCtrl> {
  public:
    virtual ~ros2_custom_msgs_msg_PoseCtrl_common(){}
    virtual void copy_from_struct(custom_msgs::msg::PoseCtrl* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const custom_msgs::msg::PoseCtrl* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_custom_msgs_msg_PoseCtrl_common::copy_from_struct(custom_msgs::msg::PoseCtrl* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_custom_msgs_msg_PoseCtrl_common::get_arr(MDFactory_T& factory, const custom_msgs::msg::PoseCtrl* msg,
...
class CUSTOM_MSGS_EXPORT ros2_custom_msgs_PoseCtrl_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_custom_msgs_PoseCtrl_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_custom_msgs_PoseCtrl_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<custom_msgs::msg::PoseCtrl,ros2_custom_msgs_msg_PoseCtrl_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_custom_msgs_PoseCtrl_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<custom_msgs::msg::PoseCtrl,ros2_custom_msgs_msg_PoseCtrl_common>>();
  }
  std::shared_ptr<void> ros2_custom_msgs_PoseCtrl_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<custom_msgs::msg::PoseCtrl>();
    ros2_custom_msgs_msg_PoseCtrl_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_custom_msgs_PoseCtrl_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_custom_msgs_msg_PoseCtrl_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (custom_msgs::msg::PoseCtrl*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_custom_msgs_msg_PoseCtrl_common, MATLABROS2MsgInterface<custom_msgs::msg::PoseCtrl>)
CLASS_LOADER_REGISTER_CLASS(ros2_custom_msgs_PoseCtrl_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
